...
const Checkout = () => {
  ...
  const handleOnlinePayment = async (orderData) => {
    ...
    try {
      const orderResponse = await dispatch(createPaymentOrder(totalPrice)).unwrap();
        ...
        <div className="flex flex-col lg:flex-row gap-24">
          ...
          <div className="flex-1 max-w-2xl">
            <form onSubmit={handleSubmit} className="space-y-16">
              ...
              >
                {loading ? 'Authenticating...' : `Authorize Acquisition • Rs. ${totalPrice.toLocaleString()}`}
              ...
              <div className="bg-[#FBFBFB] p-10">
                    ...
                    <div key={item._id} className="flex gap-8 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                           ...
                           <span className="text-sm font-bold text-black tracking-widest">Rs. {(item.price * item.qty).toLocaleString()}</span>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="space-y-6 pt-10 border-t border-gray-100">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-sm font-bold text-black tracking-widest">Rs. {totalPrice.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-end">
                  ...
                  <div className="pt-8 border-t border-gray-200 flex justify-between items-center">
                    ...
                    <span className="text-3xl font-bold text-black tracking-widest">Rs. {totalPrice.toLocaleString()}</span>
                  </div>
                </div>
              </div>
