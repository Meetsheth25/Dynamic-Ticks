                ...
                <div key={item._id} className="py-12 grid grid-cols-1 sm:grid-cols-12 gap-8 items-center group">
                  ...
                  <div className="col-span-7 flex gap-10 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-black tracking-widest border-b border-black w-fit pb-0.5">Rs. {item.price?.toLocaleString()}</p>
                  ...
                  <div className="col-span-12 sm:col-span-3 flex justify-between sm:flex-col sm:justify-center items-center sm:items-end gap-4 text-right">
                    <span className="text-lg font-bold text-black tracking-widest">Rs. {(item.price * item.qty).toLocaleString()}</span>
                    <button 
            ...
            <div className="sticky top-32 bg-black p-10 shadow-2xl">
              ...
              <div className="space-y-8 mb-12">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-sm font-bold text-white tracking-widest">Rs. {totalPrice.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-end">
                ...
                <div className="pt-8 border-t border-white/10">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-3xl font-bold text-white tracking-widest">Rs. {totalPrice.toLocaleString()}</span>
                  </div>
