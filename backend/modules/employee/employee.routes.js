...
import { 
  createProduct as managerCreateProduct, 
  updateProduct as managerUpdateProduct, 
  deleteProduct as managerDeleteProduct,
  getProducts as managerGetProducts
...
router.post('/manager/products', protect, employeeOrAdmin('manager'), upload.any(), managerCreateProduct);
router.put('/manager/products/:id', protect, employeeOrAdmin('manager'), upload.any(), managerUpdateProduct);
...
router.get('/reviews', protect, employeeOrAdmin('staff', 'manager'), getAllReviews);
router.delete('/reviews/:id', protect, employeeOrAdmin('staff', 'manager'), employeeDeleteReview);

// ─── USER MANAGEMENT (MANAGER/STAFF) ──────────────────────────────────────────
router.get('/users', protect, employeeOrAdmin('staff', 'manager'), getUsersForEmployee);
router.put('/users/:id/block', protect, employeeOrAdmin('staff', 'manager'), toggleUserBlockForEmployee);
